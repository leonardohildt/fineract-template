...
@Service
@CommandType(entity = "CODECAUSE", action = "UPDATE")
public class UpdateCodeCauseCommandHandler implements NewCommandSourceHandler {

    private final CodeCauseWritePlatformService writePlatformService;

    @Autowired
    public UpdateCodeCauseCommandHandler(final CodeCauseWritePlatformService writePlatformService) {
