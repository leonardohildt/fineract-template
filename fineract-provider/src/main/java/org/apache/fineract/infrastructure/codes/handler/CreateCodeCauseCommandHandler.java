...
@Service
@CommandType(entity = "CODECAUSE", action = "CREATE")
public class CreateCodeCauseCommandHandler implements NewCommandSourceHandler {

    private final CodeCauseWritePlatformService writePlatformService;

    @Autowired
    public CreateCodeCauseCommandHandler(final CodeCauseWritePlatformService writePlatformService) {
