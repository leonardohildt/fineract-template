...
@Service
@CommandType(entity = "CODECAUSE", action = "DELETE")
public class DeleteCodeCauseCommandHandler implements NewCommandSourceHandler {

    private final CodeCauseWritePlatformService writePlatformService;

    @Autowired
    public DeleteCodeCauseCommandHandler(final CodeCauseWritePlatformService writePlatformService) {
